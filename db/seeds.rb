...
measurement2 = Measurement.create!(value: "150", unit: "mmHg", measure: measure1, created_at: measure1.start_date + 1.day)
measurement3 = Measurement.create!(value: "160", unit: "mmHg", measure: measure1, created_at: measure1.start_date + 2.day)
